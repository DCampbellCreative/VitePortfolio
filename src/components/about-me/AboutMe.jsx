		...
		<div className={styles.container} id="home">
			...
			<div className={styles.card1}>
				...
				<div className={styles.column}>
					...
					<div className={styles.buttonRow}>
						<a className={styles.button} onClick={openResume} rel="noopener noreferrer" target="_blank">Resume</a>
						<a className={styles.button} href="https://github.com/DCampbellCreative/" rel="noreferrer" target="_blank">GitHub</a>
					</div>
				</div>
			...
			<div className={styles.row}>
				...
				<div className={styles.card}>
					...
					<p className={styles.copy}>Built and tested multiple APIs using Java, Spring Boot, Postman, and PostGres.</p>
					<div className={styles.imageContainer}>
				...
				<div className={styles.card}>
					...
					<p className={styles.copy}>Bachelor&apos;s degree in Visual Communications, with minor in Graphic Design, from the University of South Carolina. Over 15 years experience designing ads, print materials, and online content using Adobe Creative Suite and other tools.</p>
					<div className={styles.imageContainer}>
